...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw] at (7,4.75) {9\\12};
		\node[align=center, box, draw] at (9,4.75) {11\\13};
		\node[align=center, box, draw] at (12.5,4.75) {13\\9};		
		\draw [thick] (-4,2) -- (18,2);
...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw, fill = green] at (7,.5) {9\\12};
...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw, fill = orange] at (7,.5) {9\\12};
...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw, fill = orange] at (7,-2) {13\\9};
...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw] at (7,.5) {9\\12};
		\node[align=center] at (8.5,.5) {1.5};
		\node[align=center, box, draw, fill = green] at (14,.5) {11\\13};
		\node[align=center] at (15.5,.5) {0.5};
