...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw, fill = green] at (7,.5) {13\\9};
...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw, fill = orange] at (7,.5) {13\\9};
		\node[align=center] at (8.5,.5) {1.5};
		\node[align=center, box, draw,fill=orange] at (14,.5) {11\\13};
...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw, fill = orange] at (14,-2) {13\\9};
...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw, fill = orange] at (7,.5) {13\\9};
		\node[align=center] at (8.5,.5) {1.5};
		\node[align=center, box, draw] at (14,.5) {11\\13};
		\node[align=center] at (15.5,.5) {0.5};
		...
		\node[align=center, box, draw, fill = orange] at (14,-4.5) {9\\12};
...
\begin{frame}
	...
	\begin{tikzpicture} [scale=.5]
		...
		\node[align=center, box, draw] at (14,-2) {13\\9};
		\node[align=center] at (15.5,-2) {1.0};
...
\begin{frame}
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[width=.7\textwidth]{percent_graph/percent}
	\end{center}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\includegraphics[width=0.3\textwidth]{percent_graph/percent}
\end{center}
\end{frame}
